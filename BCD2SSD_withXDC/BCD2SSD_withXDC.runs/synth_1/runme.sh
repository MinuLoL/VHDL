...
HD_PWD='C:/Users/endle/Desktop/VHDL/BCD2SSD_withXDC/BCD2SSD_withXDC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd2ssd_tt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd2ssd_tt.tcl
