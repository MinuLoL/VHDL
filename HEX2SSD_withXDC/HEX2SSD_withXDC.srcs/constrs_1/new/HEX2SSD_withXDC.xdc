...
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { f[6] }]; #IO_L18N_T2_34 Sch=pio[01]   --segment num1
set_property -dict { PACKAGE_PIN M4    IOSTANDARD LVCMOS33 } [get_ports { f[5] }]; #IO_L19P_T3_34 Sch=pio[02]   --segment num2
set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { f[4] }]; #IO_L19N_T3_VREF_34 Sch=pio[03]  --3
set_property -dict { PACKAGE_PIN N2    IOSTANDARD LVCMOS33 } [get_ports { f[3] }]; #IO_L20P_T3_34 Sch=pio[04]       --4
